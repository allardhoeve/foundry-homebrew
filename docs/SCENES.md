...
Each scene JSON follows the Foundry v13 schema (background image, grid config, walls, lights, tokens, etc.). Reference example: `third_party/foundryvtt-13.351/public/nue/defaultscene/scene.json`.
